const CACHE = 'galaxy-sprite-checklist-v139';
const CORE = [
  './',
  './index.html',
  './styles.css?v=135',
  ...
  './feature-config-v129.js?v=139',
  './app.js?v=139',
  './cloud-config-v128.js?v=128',
  './cloud-v128.js?v=135',
  './profile-v133.js?v=139',
